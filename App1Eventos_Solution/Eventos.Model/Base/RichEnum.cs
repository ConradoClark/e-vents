...
namespace Eventos.Model.Base
{
          ...
          where TDerived : RichEnum<TValue, TDerived>
    {
        ...
        /// </summary>
        private DisplayAttribute _descriptionAttribute;

        /// <summary>
        /// Reverse lookup to convert values back to local instances
        /// </summary>
        private static readonly SortedDictionary<TValue, TDerived> _values = new SortedDictionary<TValue, TDerived>();
        ...
        static RichEnum()
        {
            ...
            {
                /*var dummy =*/
                field.GetValue(null); // forces static initializer to run for TDerived

                TDerived instance = (TDerived)field.GetValue(null);
                instance._name = field.Name;
                instance._descriptionAttribute = field.GetCustomAttributes(true).OfType<DisplayAttribute>().FirstOrDefault();
            }
        }
        ...
        public static TDerived Parse(string name)
        {
            foreach (TDerived value in Values)
                if (0 == string.Compare(value.Name, name, StringComparison.CurrentCulture))
                    return value;
